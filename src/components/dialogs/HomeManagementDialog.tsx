...
export function HomeManagementDialog({ 
  ...
  const handleInviteMember = async () => {
    ...
    try {
      ...
      toast.success('Invitación creada. Copia el link o token desde la lista.');
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-muted/50 rounded-md">
                      <p className="text-xs text-muted-foreground">
                        💡 Una vez creada la invitación, podrás copiar el enlace o el token desde la lista de invitaciones pendientes para compartirlo con tu roomie.
                      </p>
                    </div>
